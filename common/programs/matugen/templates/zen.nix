    ...
    "matugen/templates/zen.css" = {
      ...
      text =
        ...
        ''
          ...
          /* --- Hellwal Colors (Identity Tags) --- */

          .identity-color-blue {
            --identity-tab-color: #%%color12.hex%% !important;
            --identity-icon-color: #%%color12.hex%% !important;
          }

          .identity-color-turquoise {
            --identity-tab-color: #%%color6.hex%% !important;
            --identity-icon-color: #%%color6.hex%% !important;
          }

          .identity-color-green {
            --identity-tab-color: #%%color10.hex%% !important;
            --identity-icon-color: #%%color10.hex%% !important;
          }

          .identity-color-yellow {
            --identity-tab-color: #%%color11.hex%% !important;
            --identity-icon-color: #%%color11.hex%% !important;
          }

          .identity-color-orange {
            --identity-tab-color: #%%color3.hex%% !important;
            --identity-icon-color: #%%color3.hex%% !important;
          }

          .identity-color-red {
            --identity-tab-color: #%%color9.hex%% !important;
            --identity-icon-color: #%%color9.hex%% !important;
          }

          .identity-color-pink {
            --identity-tab-color: #%%color13.hex%% !important;
            --identity-icon-color: #%%color13.hex%% !important;
          }

          .identity-color-purple {
            --identity-tab-color: #%%color5.hex%% !important;
            --identity-icon-color: #%%color5.hex%% !important;
          }
