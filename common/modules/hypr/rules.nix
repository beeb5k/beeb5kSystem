{
  wayland.windowManager.hyprland.settings = {
    windowrule = [
      "workspace 2, match:class ^(brave-browser|firefox|zen-beta|zen-twilight|zen|obsidian)$"
      "workspace 1, match:class ^(foot|footclient|alacritty|Alacritty|com.mitchellh.ghostty|)$"
      "workspace 3, match:class ^(vesktop|discord|thunderbird|Element)$"
      ...
      "float on, center on,size 40%, match:class ^(xdg-desktop-portal-gtk)$"
